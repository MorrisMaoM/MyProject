...
<body class="body-wrapper" style="background-color:	white;">
			...
			<div class="row">
					<div class="col-lg-6 col-md-6">
						...
						<div class="widget personal-info" style="width:1000px; height:800px;">
							<h3 class="widget-header user"><font size="6"><center>會員訂單資訊</center></font></h3>
				
								<!-- Last Name -->
								<div>
									<jsp:include page="/front-end/order_table/Consumer_mail_complete_page.jsp"></jsp:include>
								</div>
