								...
								<c:when test="${authority_compy!=null }">
									...
									<ul>
										<li class="hassubs active" >
											<a href="<%=request.getContextPath()%>/front-end/Guest_Table/home.jsp">會員專區</a>
											<ul>
												<li style="width: 56px;"><a href="<%=request.getContextPath() %>/front-end/compy_table/front_CompyMembershipPlatform_info.jsp?display=1">會員資訊</a></li>																						
											</ul>
										</li>														
