...
<%-- 					<td>${order_tableVO.rs_table_status}</td> --%>
					...
					<c:choose>
						<c:when test="${order_rest_tableVO.order_status==2}">
							<a href="<%=request.getContextPath()%>/front-end/Feedback_Table/frontaddFeedback.jsp?order_id=${order_rest_tableVO.order_id}&rs_id=${order_rest_tableVO.rs_id}" target="_self">
